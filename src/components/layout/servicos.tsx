// Importe o useState, useEffect e o Button no início do seu arquivo
            ...
            {servicos.map((servico) => (
              ...
              >
                <div className="relative z-10">
                  ...
                  <Button className='rounded-md mx-auto bg-bronzeado_claro' onClick={() => whats('+5577991835717', servico.name_serv)}>
                    AGENDAR HORÁRIO
                  </Button>
                </div>
              </div>
